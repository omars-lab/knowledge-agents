...
async def seed_sections(
    ...
    delay: float = 0.5,
    summarize_model: str = "lm_studio/ministral-3-14b-reasoning",
) -> PipelineStats:
...
def main():
    ...
    parser.add_argument("--summarize-model", default="lm_studio/ministral-3-14b-reasoning", help="Model for summarization")
